...
if nargs == nargs_req:
    ...
    print("")
    print("     Usage:")
    print("       " + script_name + " <arrecon_year> <iop_str> <series_id> <exp_id_ref> <region> <output_root>")
    print("")
    print("     Example:")
    print("       python " + script_name + " 2022 full 05 03 global ../")
    print("")
    print("")
...
FILE_REF = 'stats_fv3jedi-omb_arrecon' + arrecon_year_str + iop_str + '_exp' + series_id + exp_id_ref + '_bin-' + \
           str(inc_hgt_bins_m) + 'm_' + region + '.txt'
FILE_OBS = 'stats_fv3jedi-omb_arrecon' + arrecon_year_str + iop_str + '_exp' + series_id + '0[3456]_bin-' + \
           str(inc_hgt_bins_m) + 'm_' + region + '.txt'
...
#symbol_absvalue = u'$\u007C$'
#xlabel_str_abs = r'$\left\vert \dfrac{O_{\alpha} - B_{\alpha}}{B_{\alpha}} \right\vert \, [\%]$'
xlabel_str_abs = r'$| \text{Mean } \dfrac{O_{\alpha} - B_{\alpha}}{B_{\alpha}} |$' +'  [%]'
#xlabel_str_abs = r'$\left| \dfrac{O_{\alpha} - B_{\alpha}}{B_{\alpha}} \right| \, [\%]$'
#xlabel_str_abs = r'$\left\lvert \dfrac{O_{\alpha} - B_{\alpha}}{B_{\alpha}} \right\rvert \, [\%]$'
#xlabel_str_abs = r'$\left\lvert\dfrac{O_{\alpha}' + u"\u2212" + r'B_{\alpha}}{B_{\alpha}}$\right\rvert'+'  [%]'
#xlabel_str_abs = symbol_absvalue + r'$\dfrac{O_{\alpha}' + u"\u2212" + r'B_{\alpha}}{B_{\alpha}}$' + symbol_absvalue + '  [%]'
#xlabel_str_abs = symbol_absvalue + 'Bias' + symbol_absvalue + '  [%]'

xlabel_str_mean = 'Diff. in ' +r'$| \text{Mean } \dfrac{O_{\alpha} - B_{\alpha}}{B_{\alpha}} |$'+ '  [%]'
#xlabel_str_mean = 'Diff. in ' + symbol_absvalue + 'Mean '+r'$\dfrac{O_{\alpha}' + u"\u2212" + r'B_{\alpha}}{B_{\alpha}}$' + symbol_absvalue + '  [%]'
...
#xlabel_str_stddev = 'Diff. in Std Dev ' +r'$\dfrac{O_{\alpha}' + u"\u2212" + r'B_{\alpha}}{B_{\alpha}}$'+ '  [%]'
...
output_name_pdf = 'stats_compare_fv3jedi-omb_absbias-diff-absbias-sigma_ref-series' + series_id + exp_id_ref + '_bin-' + \
                  str(inc_hgt_bins_m) + 'm_' + region + '.pdf'
