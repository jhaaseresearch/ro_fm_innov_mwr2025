...
if nargs == nargs_req:
    ...
    print("")
    print("     Usage:")
    print("       " + script_name + " <arrecon_year> <iop_str> <series_id> <region> <output_root>")
    print("")
    print("     Example:")
    print("       python " + script_name + " 2022 full 05 global ../")
    print("")
    print("")
...
FILE_OBS = 'stats_fv3jedi-omb_arrecon' + arrecon_year_str + iop_str + '_exp' + series_id + '0[3456]_bin-' + str(inc_hgt_bins_m) + 'm_' + region + '.txt'
...
output_name_pdf = 'stats_compare_fv3jedi-omb_count-mean-sigma_bin-' + str(inc_hgt_bins_m) + 'm_' + region + '.pdf'
